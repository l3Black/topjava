...
public class MealTestData {
    ...
    public static void assertMatchMealTos(Iterable<MealTo> actual, Iterable<MealTo> expected) {
        assertThat(actual).usingFieldByFieldElementComparator().isEqualTo(expected);
    }

    public static ResultMatcher contentJson(Iterable<MealTo> expected) {
        return result -> assertMatchMealTos(readListFromJsonMvcResult(result, MealTo.class), expected);
    }
}
