...
import static ru.javawebinar.topjava.MealTestData.assertMatchMealTos;
                ...
                .andExpect(model().attribute("meals",
                        new AssertionMatcher<List<MealTo>>() {
                            ...
                            public void assertion(List<MealTo> mealTos) throws AssertionError {
                                assertMatchMealTos(mealTos, MealsUtil.getTos(MealTestData.MEALS, SecurityUtil.authUserCaloriesPerDay()));
                            }
                        }
                ));
    }
